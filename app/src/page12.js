    ...
    <div className="container">
      <div className="main-page">
        ...
        <div className="page12numberbutton-container">
          <button className="page12numberhome-button" onClick={page12handleSubmitClick}>
            <img
              src="/main/home.png"
              alt="home icon"
          ...
          <button className="page12numberprevious-button" onClick={page12handleSubmitClick}>
            <img
          ...
          <button className="page12numbersubmit-button" onClick={page12handleSubmitClick}>
            <img
