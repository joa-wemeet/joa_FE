...
function Page14() {
    ...
    const boxStyle = {
      ...
      <div style={boxStyle}>
        <div style={upperContainerStyle}>
            ...
            <div style={boxInnerStyle}>선택 완료</div>
        </div>
  ...
  return (
    <div className="container">
            <p style={{ color: '#2e3d86', fontSize: '50px', marginBottom: '40px', textAlign: 'center',}} >
                증명서를{' '} <span style={{ color: '#d94925', fontSize: '50px' }}>추가</span>하여 일괄 발급할지 선택해주세요.
                </p>
